      ...
      <div className="grid md:grid-cols-2">
        <figure className="border-b border-border md:border-b-0 md:border-r">
          <div className="aspect-[3/2] overflow-hidden bg-background">
            <img src="/blackandwhite.jpg" alt="Grayscale historic Indian street input demonstration" width={1536} height={1024} loading="lazy" className="h-full w-full object-cover grayscale" />
          </div>
        ...
        <figure>
          <div className="aspect-[3/2] overflow-hidden bg-background">
            <img src="/coloured.jpg" alt="Realistically colorized historic Indian street output demonstration" width={1536} height={1024} loading="lazy" className="h-full w-full object-cover" />
          </div>
